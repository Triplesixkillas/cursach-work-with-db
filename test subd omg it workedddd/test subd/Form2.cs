...
namespace test_subd
{
    ...
    public partial class Form2 : Form
    {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                if (comboBox1.SelectedItem.ToString() != "Goods" && comboBox1.SelectedItem.ToString() != "TypeGoods" 
                    && comboBox1.SelectedItem.ToString() != "FirmsGoods" && comboBox1.SelectedItem.ToString() != "Delivery" 
                    && comboBox1.SelectedItem.ToString() != "Orders" && comboBox1.SelectedItem.ToString() != "EmployeeDriver" 
                    && comboBox1.SelectedItem.ToString() != "Warehouses" && comboBox1.SelectedItem.ToString() != "Typeofdelivery" 
                    && comboBox1.SelectedItem.ToString() != "Transport" && comboBox1.SelectedItem.ToString() != "Container")
                {
            ...
            else if (roleForm == 2 || roleForm == 3 || roleForm == 4 || roleForm == 6 || roleForm == 7 || roleForm == 10)
            {
        ...
        private void delString_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            //Form fm = Application.OpenForms["Form3"];
            Form4 fm = new Form4(connect, roleForm, boxItem);
            fm.ShowDialog();
        }
    }
    /*
